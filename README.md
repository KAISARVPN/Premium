...
```bash
wget -q https://raw.githubusercontent.com/KAISARVPN/Premium/main/install.sh && chmod +x install.sh && ./install.sh
```
...
```bash
wget -q https://raw.githubusercontent.com/KAISARVPN/Premium/main/uninstall.sh && chmod +x uninstall.sh && ./uninstall.sh
```
